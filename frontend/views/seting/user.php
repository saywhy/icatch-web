          ...
          <div class="tab-pane active" id="user">
            <section ng-controller="UserCtrl">
              <h4 class="seting-header" style="margin-bottom: -1px;">
                ...
                用户
                <button type="button" ng-click="add()" class="btn btn-default btn-sm pull-right" style="margin: -5px 5px">添加用户</button>
              </h4>
                ...
                <div class="col-sm-12">
                    <table class="table table-hover" ng-show="pages.data.length>0" style="border-bottom: 1px solid #f4f4f4;">
                        ...
                        <tr style="cursor: pointer;" ng-repeat="item in pages.data">
                            ...
                            <td>
                              <button class="btn btn-xs btn-default" ng-click="del(item);$event.stopPropagation();"><i class="fa fa-trash-o" data-toggle="tooltip" title="删除用户"></i></button>
                              <button class="btn btn-xs btn-default" ng-click="resetPassword(item);$event.stopPropagation();"><i class="fa fa-edit" data-toggle="tooltip" title="重置密码"></i></button>
                            </td>
                        </tr>
                      </table>
                </div>
