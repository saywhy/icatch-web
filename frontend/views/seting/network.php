            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="email">
                            ...
                            <div class="row ng-cloak" ng-if="nowDevice">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="pull-left">
                                                <input class="tgl tgl-ios" id="ONBOOT" type="checkbox" ng-checked="devices[nowDevice].ONBOOT == 'yes'"
                                                    ng-click="devices[nowDevice].ONBOOT = (devices[nowDevice].ONBOOT=='yes'?'no':'yes')">
                                    ...
                                    <div ng-if="devices[nowDevice].ONBOOT=='yes'">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <select id="BOOTPROTO" ng-model="devices[nowDevice].BOOTPROTO" class="form-control"
                                                    ng-options="item.value as item.text for item in [{value:'dhcp',text:'自动获取IP'},{value:'static',text:'手动设置IP'}]">
                                                </select>
                                            </div>
                        ...
                        <section class="ng-cloak" ng-if="nowDevice && changed">
                        ...
                        <section>
                            <div class="http">
                                ...
                                <div class="item-http">
                                    ...
                                    <div class="col-sm-4">
                                        <input class="form-control" placeholder="http://[user:pass@]host[:port]"
                                            ng-model="httpModel">
                                    </div>
                                ...
                                <div class="item-http">
                                    ...
                                    <div class="col-sm-4">
                                        <input class="form-control" placeholder="https://[user:pass@]host[:port]"
                                            ng-model="httpsModel">
                                    </div>
...
<script type="text/javascript">
    ...
    myApp.controller('myCtrl', function ($scope, $http, $filter) {
                ...
                if (rsp.data.status == 'success') {
                    ...
                    if (!watching) {
                        $scope.$watch('nowDevice', function (newValue, oldValue, scope) {
                            $scope.devices[oldValue] = angular.copy($scope.oldDevices[
                                oldValue]);
                        });
        ...
        $scope.getProxy = function (params) {
            $http.get('/seting/get-proxy').then(function success(rsp) {
                //  console.log(rsp.data.result.HTTPS_PROXY);
                console.log(rsp);
                if (rsp.data.status == 'success') {
                    $scope.httpsModel = rsp.data.data.https
                    $scope.httpModel = rsp.data.data.http
                } else {
        ...
        $scope.saveHttps = function () {
            var params = {
                https: $scope.httpsModel,
                http: $scope.httpModel
            };
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.status== 'success'){
                        ...
                        zeroModal.error(data.errorMessage);
                    }
                },
