    ...
    <div class="col-md-12">
      <div class="box box-solid">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="glyphicon glyphicon-globe "></i> <?= $EX['URL'] ?></h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-4 border-right">
              <div class="user-block">
                <!-- <img class="img-circle img-bordered-sm" src="/images/icos/file_detail.png" alt="user image"/> -->
                  <span class="ico glyphicon glyphicon-globe text-gray" ></span>
            ...
            <!-- #f4f4f4 -->
              <div class="user-block">
                <span class="description text">
                  ...
                  <span class="description text">
                    <span>受感染区域：</span>
                    <span><?=$EX['Detail']['geo'] ?></span>
                  </span>
                  <span class="description text">
                    <span>家族：</span>
                    <span><?=$EX['Detail']['threat'] ?></span>
                  </span>
                  <span class="description text">
                    <span>恶意程序MD5：</span>
                    <span><?=$EX['Detail']['md5'] ?></span>
                  </span>
              ...
              <div class="user-block" style="border-top: 1px solid #f4f4f4;">
                  <span class="description text">
                    <span>域名：</span>
                    <span><?=$EX['Detail']['domain'] ?></span>
                  </span>
                  <span class="description text">
                    <span>域名创建日期：</span>
                    <span><?=$EX['Detail']['created'] ?></span>
                  </span>
                  <span class="description text">
                    <span>域名最近一次更新时间：</span>
                    <span><?=$EX['Detail']['update'] ?></span>
                  </span>
                  <span class="description text">
                    <span>域名过期时间：</span>
                    <span><?=$EX['Detail']['expires'] ?></span>
                  </span>
                  <span class="description text">
                    <span>威胁来源：</span>
                    <?php
            ...
            <div class="col-md-4 ng-cloak">
              ...
              <button ng-click="updata('delWhite')" class="btn btn-danger" ng-if="EX.status == 4">移出白名单</button>
              <?php }else{?>
              ...
              <div class="user-block">
                  ...
                  <span class="description text">
                    <span>注册者名字：</span>
                    <span><?=$EX['Detail']['name'] ?></span>
                  </span>
                  <span class="description text">
                    <span>注册公司：</span>
                    <span><?=$EX['Detail']['org'] ?></span>
                  </span>
                  <span class="description text">
                    <span>国家：</span>
                    <span><?=$EX['Detail']['conutry'] ?></span>
                  </span>
                  <span class="description text">
                    <span>城市：</span>
                    <span><?=$EX['Detail']['city'] ?></span>
                  </span>
                  <span class="description text">
                    <span>email地址：</span>
                    <span><?=$EX['Detail']['email'] ?></span>
                  </span>
                  <span class="description text">
                    <span>域名登记公司：</span>
                    <span><?=$EX['Detail']['registrar_name'] ?></span>
                  </span>
                  <span class="description text">
                    <span>域名登记公司邮件地址：</span>
                    <span><?=$EX['Detail']['registrar_email'] ?></span>
                  </span>
              </div>
            </div>
